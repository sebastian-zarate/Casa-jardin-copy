...
>
  ...
  >
    ...
    <input className="flex flex-col items-center" type="password" id="password" style={{ padding: '3px', borderRadius: '5px', marginBottom: '20px', width: '400px'}} />
    ...
    <div className="flex items-center justify-center">
     <span className=" font-medium">No tienes cuenta?</span> 
      <a href="/signup" className=" font-bold text lg text-black ml-2">Registrate</a>
      </div>
  </div>
</div>
