...
import { addDireccion, Direccion,  getDireccionById, updateDireccionById } from "@/services/ubicacion/direccion";
import { addProvincias,  getProvinciasById, getProvinciasByName, Provincia, updateProvinciaById } from "@/services/ubicacion/provincia";
            ...
            {selectedProfesional !== null && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div ref={scrollRef} className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg relative" style={{ height: '70vh', overflow: "auto" }}>
                        ...
                        {(!nacionalidadName && !provinciaName && !localidadName && !calle && !numero && obProfesional?.direccionId !== null) && <p className=" text-red-600">Cargando su ubicación...</p>}
                        {(nacionalidadName || obProfesional?.direccionId === null) && <div className="mb-4">
                        ...
                        {(provinciaName || obProfesional.direccionId === null) && <div className="mb-4">
                        ...
                        {(localidadName || !obProfesional.direccionId) && <div className="mb-4">
                        ...
                        {((calle && numero) || !obProfesional.direccionId) && <div className="mb-4">
